...
export interface Database {
  public: {
    Tables: {
      ...
      // ----------------------------------------------------------------
      // refund_requests — buyer return/refund requests
      // ----------------------------------------------------------------
      refund_requests: {
        Row: {
          id: string;
          ...
          order_id: string;
          profile_id: string;
          reason: "defective_damaged" | "incorrect_items" | "not_as_described" | "other";
        ...
        Insert: {
          id?: string;
          reference?: string; // auto-generated by trigger if omitted
          order_id: string;
          profile_id: string;
          reason: "defective_damaged" | "incorrect_items" | "not_as_described" | "other";
          date_received: string;
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "refund_requests_profile_id_fkey";
            columns: ["profile_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "refund_requests_acknowledged_by_fkey";
